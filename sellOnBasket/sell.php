                                      ...
                                      <div class="personal-form" >
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class>
                                                ...
                                                <div class="userright">
                                                    ...
                                                    <div class="dropdown">
                                                     <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="false">Select Vegetables <i class="fa fa-angle-down ml-5"></i></a>
                                                     <ul class="dropdown-menu dropdown-menu-left">
                                                        <li><a href="../login/logout.php">Tomato</a></li>
                                                        <li><a href="#">potatos</a></li>
                                                        <li><a href="#">Privacy Policy</a></li>
                                                        <li><a href="#">Terms & Conditions</a></li>
                                                        <li><a href="#">About Us</a></li>
                                                     </ul>
