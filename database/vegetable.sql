...
insert into vegetable (name,image) values('garlic','garlic.png');
insert into vegetable (name,image) values('green_chilli','green_chilli.png');
insert into vegetable (name,image) values('lemon','lemon.png');
insert into vegetable (name,image) values('onion','onion.png');
insert into vegetable (name,image) values('raddish','raddish.png');
insert into vegetable (name,image) values('tomato','tomato.png');
insert into vegetable (name,image) values('baby_corn','baby_corn.png');
insert into vegetable (name,image) values('beetroot','beetroot.png');
insert into vegetable (name,image) values('bottle_gourd','bottle_gourd.png');
insert into vegetable (name,image) values('brocoli','brocoli.png');
insert into vegetable (name,image) values('cabbage','cabbage.png');
insert into vegetable (name,image) values('capsicum','capsicum.png');
insert into vegetable (name,image) values('cauliflower','cauliflower.png');
